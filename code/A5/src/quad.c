...
#include "forces.h"
//=======================================================================================================
// typedef struct build_tree_args {
//     quadtree_t** tree;
...
#endif
//==========================================================================================
// void* build_tree_wrapper(void* argument) {
//     build_tree_args_t* args = argument;

//     for(int i = args->start; i < args->stop; i++) {
//         quadtree_add_particle(args->tree, args->particles[i], args->box);
//     }
//     return NULL;
// }
//==========================================================================================
void quadtree_build_tree(quadtree_t** tree, particle_t* particles, int N/*, int nthreads*/) {
    box_bounds_t box = {0, 1, 0, 1};
    
    // pthread_t* thread_ptr = malloc(nthreads*sizeof(pthread_t));
    // build_tree_args_t* args = malloc(nthreads*sizeof(build_tree_args_t));
    ...
    //     pthread_create(&thread_ptr[i], NULL, build_tree_wrapper, &args[i]);
